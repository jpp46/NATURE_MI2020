...
#ifdef USE_OMP
#pragma omp parallel for shared(Diverged, linksList) num_threads(8)
#endif
...
#ifdef USE_OMP
#pragma omp parallel for shared(voxelsList) num_threads(8)
#endif
...
void CVoxelyze::updateCollisions()
{
    ...
    {
#ifdef USE_OMP
#pragma omp parallel for shared(voxelsList, nearbyStale, collisionsStale) num_threads(8)
#endif
...
#ifdef USE_OMP
#pragma omp parallel for shared(collisionsList) num_threads(8)
#endif
