...
/*!The constructor takes the two voxel materials and calculates the "best" material properties of a third material that
captures the physical behavior. Beam constants are precomputed to quick access during simulation.
...
class CVX_MaterialLink : public CVX_MaterialVoxel
{
  public:
    CVX_MaterialLink(
        ...
        CVX_MaterialVoxel *mat2); //!< Creates a link material from the two specified voxel materials. The order is
                                  //!< unimportant. @param[in] mat1 voxel material on one side of the link. @param[in]
                                  //!< mat2 voxel material on the other side of the link.
  ...
  protected:
    virtual bool updateAll(); //!< Updates and recalculates eveything possible (used by inherited classed when material
